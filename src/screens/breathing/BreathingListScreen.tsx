...
const styles = StyleSheet.create({
  ...
  badgeText: { color: colors.textOnAccent, fontSize: fontSize.caption, fontWeight: '600' },
  methodName: { color: colors.textOnAccent, fontSize: fontSize.title + 2, fontWeight: '800' },
  ...
  paramValue: { color: colors.textOnAccent, fontSize: fontSize.subtitle, fontWeight: '800' },
